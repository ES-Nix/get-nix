...
FULL_STRING_SILENCE_DIRENV_LOGS='export DIRENV_LOG_FORMAT=""'
...
-q \
-s \
"${FULL_STRING_SILENCE_DIRENV_LOGS}" \
"${FULL_PATH_TO_GUESSED_SHELL_RC}" || echo "${FULL_STRING_SILENCE_DIRENV_LOGS}" >> "${FULL_PATH_TO_GUESSED_SHELL_RC}"
